...
//Add intent-filter to the AndroidManifest.xml file to register the deep link URL:
...
//Create the PBBAConfiguration objectSet deepLinkScheme to the defined scheme in the AndroidManifest.xml file:
